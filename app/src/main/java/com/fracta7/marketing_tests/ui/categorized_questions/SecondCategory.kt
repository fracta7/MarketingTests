...
@Composable
fun SecondCategory(navController: NavController) {
    val viewModel = hiltViewModel<SecondCategoryViewModel>()
    ...
    if (viewModel.questions.isNotEmpty()) {
        ...
        Scaffold(topBar = {
            TopAppBar(title = { Text(text = "Introduction to Management&Marketing") }, navigationIcon = {
                IconButton(onClick = {
