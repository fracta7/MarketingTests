...
@Composable
fun ThirdCategory(navController: NavController) {
    val viewModel = hiltViewModel<ThirdCategoryViewModel>()
    ...
    if (viewModel.questions.isNotEmpty()) {
        ...
        Scaffold(topBar = {
            TopAppBar(title = { Text(text = "Introduction to Tourism and Hospitality Business") }, navigationIcon = {
                IconButton(onClick = {
