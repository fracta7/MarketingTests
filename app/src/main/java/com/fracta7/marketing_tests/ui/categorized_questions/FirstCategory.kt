...
@Composable
fun FirstCategory(navController: NavController) {
    val viewModel = hiltViewModel<FirstCategoryViewModel>()
    ...
    if (viewModel.questions.isNotEmpty()) {
        ...
        Scaffold(topBar = {
            TopAppBar(title = { Text(text = "Introduction to Economics") }, navigationIcon = {
                IconButton(onClick = {
