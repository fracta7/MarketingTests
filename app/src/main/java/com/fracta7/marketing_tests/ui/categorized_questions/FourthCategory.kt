...
@Composable
fun FourthCategory(navController: NavController) {
    val viewModel = hiltViewModel<FourthCategoryViewModel>()
    ...
    if (viewModel.questions.isNotEmpty()) {
        ...
        Scaffold(topBar = {
            TopAppBar(title = { Text(text = "ICT in Tourism") }, navigationIcon = {
                IconButton(onClick = {
